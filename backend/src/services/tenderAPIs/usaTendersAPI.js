...
class USATendersAPI {
  ...
  async fetchTenders(params = {}) {
    try {
      const defaultParams = {
        limit: 50,
        offset: 0,
        postedFrom: this.formatDate(new Date(Date.now() - 30 * 24 * 60 * 60 * 1000)),
    ...
    return [
      {
        ...
        description: 'Develop and implement an AI-driven traffic management system for smart city initiative including real-time optimization and predictive analytics capabilities.',
        country: 'USA',
        region: 'National',
        budget: 2800000,
      ...
      },
      {
        ...
        description: 'Implementation of comprehensive cybersecurity framework for federal agencies including threat detection, incident response, and compliance monitoring systems.',
        country: 'USA',
        region: 'Federal',
        budget: 5500000,
        deadline: new Date(Date.now() + 60 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Cybersecurity',
        requirements: ['Cybersecurity', 'Incident Response', 'Compliance', 'Risk Assessment'],
        status: 'open',
        source: 'SAM.gov',
        sourceUrl: 'https://sam.gov/opp/',
        contactInfo: {
      ...
      },
      {
        ...
        description: 'Modernization of legacy government systems to cloud-based infrastructure with focus on scalability, security, and cost optimization.',
        country: 'USA',
        region: 'Multi-State',
        budget: 12000000,
        deadline: new Date(Date.now() + 75 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Cloud Computing',
        requirements: ['Cloud Computing', 'System Migration', 'Security', 'DevOps'],
        status: 'open',
        source: 'SAM.gov',
        sourceUrl: 'https://sam.gov/opp/',
        contactInfo: {
  ...
  transformTenders(data) {
    return data.map(tender => ({
      ...
      title: tender.title,
      description: tender.description || tender.synopsis || 'No description available',
      country: 'USA',
  ...
  extractRequirements(description) {
    ...
    const keywords = ['AI', 'ML', 'Cloud', 'Software', 'IT', 'Security', 'Data', 'Analytics', 'IoT', 'DevOps'];
