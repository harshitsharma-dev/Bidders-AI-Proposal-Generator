...
class CanadaTendersAPI {
  constructor() {
    this.baseURL = 'https://buyandsell.gc.ca/procurement-data/open-contracting-data';
  ...
  async getOpenContractingData() {
    try {
      const response = await axios.get('https://buyandsell.gc.ca/cds/public/ocds/tenders.json', {
        timeout: 10000,
        headers: {
      ...
      console.log('Canadian Open Contracting API not accessible, using mock data');
      return [];
    }
  }
    ...
    return [
      {
        ...
        description: 'Development of a comprehensive digital platform for federal government services delivery, including citizen portal, API management, cloud infrastructure, and bilingual support capabilities.',
        country: 'Canada',
        region: 'Federal',
        budget: 7200000,
        deadline: new Date(Date.now() + 60 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Digital Services',
        requirements: ['Cloud Computing', 'API Development', 'Security', 'Bilingual Support', 'Accessibility'],
        status: 'open',
      ...
      },
      {
        ...
        description: 'Implementation of advanced analytics platform for healthcare data processing across Ontario, including AI-powered insights, privacy compliance, and integration with existing health systems.',
        country: 'Canada',
        region: 'Ontario',
        budget: 4800000,
        deadline: new Date(Date.now() + 45 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Healthcare Technology',
        requirements: ['Healthcare IT', 'Data Analytics', 'AI/ML', 'Privacy Compliance', 'System Integration'],
        status: 'open',
        source: 'BuyandSell.gc.ca',
        sourceUrl: 'https://buyandsell.gc.ca',
        contactInfo: {
      ...
      },
      {
        ...
        description: 'Development of intelligent transportation system for Greater Vancouver area, including traffic optimization, public transit integration, and environmental impact monitoring.',
        country: 'Canada',
        region: 'British Columbia',
        budget: 9500000,
        deadline: new Date(Date.now() + 70 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Transportation Technology',
        requirements: ['IoT', 'Transportation Systems', 'Data Analytics', 'Environmental Monitoring', 'System Integration'],
        status: 'open',
        source: 'BuyandSell.gc.ca',
        sourceUrl: 'https://buyandsell.gc.ca',
        contactInfo: {
      ...
      },
      {
        ...
        description: 'Establishment of provincial cybersecurity operations center for Quebec government agencies, including threat monitoring, incident response, and security awareness training programs.',
        country: 'Canada',
        region: 'Quebec',
        budget: 5600000,
        deadline: new Date(Date.now() + 55 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Cybersecurity',
        requirements: ['Cybersecurity', 'Incident Response', 'Security Monitoring', 'Bilingual Support', 'Training'],
        status: 'open',
        source: 'BuyandSell.gc.ca',
        sourceUrl: 'https://buyandsell.gc.ca',
        contactInfo: {
  ...
  transformTenders(data) {
    return data.map(tender => ({
      ...
      description: tender.tender?.description || tender.description || 'No description available',
      country: 'Canada',
  ...
  extractRegion(tender) {
    ...
    if (location && location.description) {
      ...
      if (location.description.includes('British Columbia')) return 'British Columbia';
  ...
  extractRequirements(description) {
    ...
    const keywords = ['Digital', 'Technology', 'Software', 'Cloud', 'AI', 'Data', 'Security', 'Healthcare', 'IoT'];
