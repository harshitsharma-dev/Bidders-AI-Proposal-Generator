...
class UKTendersAPI {
    ...
    return [
      {
        ...
        description: 'Development of a comprehensive digital platform for government services delivery, including citizen portal, API management, and cloud infrastructure with focus on accessibility and security.',
        country: 'UK',
        region: 'England',
        budget: 4200000,
        deadline: new Date(Date.now() + 50 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Digital Services',
        requirements: ['Digital Services', 'API Development', 'Cloud Computing', 'Security', 'Accessibility'],
        status: 'open',
      ...
      },
      {
        ...
        description: 'Implementation of integrated digital health records system for NHS trusts across England, including patient portal, clinical decision support, and interoperability features.',
        country: 'UK',
        region: 'England',
        budget: 8900000,
        deadline: new Date(Date.now() + 65 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Healthcare Technology',
        requirements: ['Healthcare IT', 'Database Management', 'API Integration', 'Security', 'Compliance'],
        status: 'open',
        source: 'Find a Tender',
        sourceUrl: 'https://www.find-tender.service.gov.uk',
        contactInfo: {
      ...
      },
      {
        ...
        description: 'Implementation of IoT sensor network and data analytics platform for Edinburgh smart city initiative, including traffic management, environmental monitoring, and energy optimization.',
        country: 'UK',
        region: 'Scotland',
        budget: 3100000,
        deadline: new Date(Date.now() + 40 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Smart Infrastructure',
        requirements: ['IoT', 'Data Analytics', 'Cloud Computing', 'System Integration', 'Environmental Monitoring'],
        status: 'open',
        source: 'Find a Tender',
        sourceUrl: 'https://www.find-tender.service.gov.uk',
        contactInfo: {
      ...
      },
      {
        ...
        description: 'Development of regulatory technology platform for financial services compliance monitoring, including real-time transaction analysis and automated reporting capabilities.',
        country: 'UK',
        region: 'England',
        budget: 6500000,
        deadline: new Date(Date.now() + 55 * 24 * 60 * 60 * 1000).toISOString(),
        category: 'Financial Technology',
        requirements: ['Financial Services', 'Compliance', 'Real-time Analytics', 'Regulatory Technology', 'Security'],
        status: 'open',
        source: 'Find a Tender',
        sourceUrl: 'https://www.find-tender.service.gov.uk',
        contactInfo: {
  ...
  extractRequirements(description) {
    ...
    const keywords = ['Software', 'IT', 'Technology', 'Digital', 'Cloud', 'Security', 'Data', 'Analytics', 'AI', 'IoT'];
