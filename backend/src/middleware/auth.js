...
const proposalRateLimit = rateLimit({
  ...
  message: {
    ...
    message: 'Too many proposal requests. You can generate maximum 2 proposals per hour. Please try again later.',
    retryAfter: '1 hour'
  },
...
const authenticateUser = (req, res, next) => {
  try {
    ...
    const isCommonError = error.name === 'JsonWebTokenError' && 
